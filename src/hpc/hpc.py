...
def main():
    ...
    start_time = time.time()
    print(f"Fibonacci({n}) with caching: \t{fibonacci_cached(n)} (in {(time.time() - start_time):.6f} seconds)")

    # n =  36 done in 5 seconds
    # n =  37 done in 8 seconds
    # n =  38 done in 13 seconds
    start_time = time.time()
    print(f"Fibonacci({n}) without caching: \t{fibonacci(n)} (in {(time.time() - start_time):.6f} seconds)")
